  ...
  children: [
...

    {
      ...
      children: [
        ...
        {
          path: 'counter',
          loadChildren: () => import('./counter/counter.component').then(m => m.CounterComponent),
          data: {
            title: 'Counter'
          }
        },
        ...
        {
          path: 'fetch-data',
          loadChildren: () => import('./fetch-data/fetch-data.component').then(m => m.FetchDataComponent),
          data: {
            title: 'Fetch-data'
          }
        },
        ...
        //{
        //  path: 'swagger',
        //  loadChildren: () => new Promise(() => {window.location.href = '/api'; }),
        //  data: {
        //    title: 'Api Swagger'
        //  }
        //},
