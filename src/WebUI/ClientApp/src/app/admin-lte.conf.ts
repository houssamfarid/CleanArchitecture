export const adminLteConf = {
  ...
  sidebarLeftMenu: [
    ...
    {
      label: 'Original App', iconClasses: 'fa fa-th-list', children: [
        { label: 'Counter Page', route: 'counter' },
        { label: 'FechData Page', route: 'fetch-data' },
        { label: 'Todo Page', route: 'todo' },
        { label: 'Swagger Page', route: 'swagger' },
      ]
    },
